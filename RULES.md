# WC2026 Friends Pool — Rules

Everyone drafts teams from three odds-tiered pots. Your teams earn (and lose) points across the whole tournament from the categories below. Most points at the end wins. The pool leans into chaos — plenty of ways to score are deliberately perverse, so read carefully.
...
## The full-time injury-time (90+X) rule
